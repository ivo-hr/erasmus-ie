...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.setOnItemClickListener(new CourseRVAdapter.OnItemClickListener() {
            ...
            public void onItemClick(CourseModal model) {
                ...
                intent.putExtra(NewCourseActivity.EXTRA_SURNAME, model.getSurname());
                intent.putExtra(NewCourseActivity.EXTRA_EMAIL, model.getEmail());
                intent.putExtra(NewCourseActivity.EXTRA_PHONE, model.getPhone());
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == ADD_COURSE_REQUEST && resultCode == RESULT_OK) {
            String name = data.getStringExtra(NewCourseActivity.EXTRA_NAME);
            String surname = data.getStringExtra(NewCourseActivity.EXTRA_SURNAME);
            String email = data.getStringExtra(NewCourseActivity.EXTRA_EMAIL);
            String phone = data.getStringExtra(NewCourseActivity.EXTRA_PHONE);
            CourseModal model = new CourseModal(name, surname, email, phone);
